...
namespace SolarCoffee.Test
{
    ...
    {
        [Fact]
        public void Customer_GetsAllCustomers_GivenTheyExist()
        {
            ...
            var systemUnderTest = new CustomerService(context);

            systemUnderTest.CreateCustomer(new Customer {Id = 123123});
            systemUnderTest.CreateCustomer(new Customer {Id = 213123});

            var allCustomers = systemUnderTest.GetAllCustomers();
